...
### 18. Get All Categories (SuperAdmin)
...
**Endpoint:** `GET /v1/admin/categories/{category_id}/items`
  ...
  "data": [
    {
      ...
      "image_url": "https://example.com/alphabet-a.jpg",
...
### 21. Create Category Item
**Endpoint:** `POST /v1/admin/category-items`
...
```json
{
  ...
  "en_name": "Elephant",
  "te_name": "ఏనుగు",
  "te_transliteration": "Enugu",
  "hi_name": "हाथी",
  "hi_transliteration": "Haathi",
  "kn_name": "ಆನೆ",
  "kn_transliteration": "Aane",
  "gu_name": "હાથી",
  "gu_transliteration": "Haathi",
  "image_url": "https://example.com/elephant.jpg",
  "explanation": "A large mammal with a trunk",
  "video_url": "https://example.com/videos/elephant.mp4"
}
```

### 22. Get Item Details
**Endpoint:** `GET /v1/admin/category-items/{item_id}/details`
...
### 23. Bulk Import Categories
**Endpoint:** `POST /v1/admin/categories/bulk-import`
  ...
  "failed_records": [
    {
      "row": 3,
      "data": {
        "en_name": "Invalid Category"
      },
      "error": "Missing required field: allowed_lang"
    },
    {
      "row": 7,
      "data": {
        "en_name": "Duplicate Category"
      },
...
### 24. Bulk Import Items
**Endpoint:** `POST /v1/admin/categories/{category_id}/items/bulk-import`
...
### 25. Bulk Import Item Details
**Endpoint:** `POST /v1/admin/category-items/details/bulk-import`
...
{
  "success": true,
  "message": "Item details imported successfully",
  "imported_count": 20,
  "failed_count": 0,
  "failed_records": []
}
